               ...
               <div className= "carousel-inner">
                  <div className= "carousel-item active">
                     <div className= "container">
                        ...
                        <div className= "read_bt"><Link href= "#">Get A Quote</Link></div>
                     </div>
                  </div>
               </div>
            </div>
                ...
                <div className= "client_section_2">
                   <div id="carouselExampleIndicators" className= "carousel slide" data-ride="carousel">
                      <ol className= "carousel-indicators">
                         <li data-target="#carouselExampleIndicators" data-slide-href= "0" className= "active"></li>
                         <li data-target="#carouselExampleIndicators" data-slide-href= "1"></li>
                         <li data-target="#carouselExampleIndicators" data-slide-href= "2"></li>
                      </ol>
                      <div className= "carousel-inner">
                         <div className= "carousel-item active">
                            <div className= "client_main">
                               ...
                               <div className= "box_right">
                                  <div className= "client_taital_left">
                                     <div className= "client_Image"><Image src= "../images/client-img.png" alt="Image" /></div>
                                     <div className= "quick_icon"><Image src= "../images/quick-icon.png" alt="Image" /></div>
                                  </div>
          ...
          <div className= "choose_section layout_padding">
             <div className= "container">
                ...
                <div className= "newsletter_box">
                   ...
                   <div className= "getquote_bt"><Link href= "#">Get A Quote</Link></div>
                </div>
             </div>
          </div>
         </div>
